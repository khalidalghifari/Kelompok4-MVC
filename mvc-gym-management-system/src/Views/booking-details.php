        ...
        <div class="col-lg-12">
          <table class="table table-hover table-bordered">
            <thead>
              ...
              <tr>
                ...
                <td><?php echo $data['PackageDuratiobn']; ?></td>
                <th>Price</th>
                <td><?php echo $data['Price']; ?></td>
                <?php $pricess = $data['Price']; ?>
              </tr>
              <tr>
                <th>Description</th>
              ...
              <tr>
                <th>PaymentType</th>
                <td colspan="3"><?php $ptype = $data['paymentType'];
                                if ($ptype == '') :
          ...
          if (true) { ?>
            <table class="table table-hover table-bordered">
              ...
              <?php foreach ($data['payment'] as $data) { ?>
                <tr>
                  <td><?php echo $data['paymentType']; ?></td>
                  <td><?php echo $tpayment = $data['payment']; ?></td>
